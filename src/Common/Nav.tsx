...
const Nav: React.FC<Props> = ({ setcurrentOption}) => {
    ...
    Start Typing......."
                ...
                <img className="w-9 h-9 p-1  rounded-full cursor-pointer hover:bg-[#2c3437]" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHy1kulKGFspFD5skFeQ_G9RzsJZ4pmAEmnQ&s" alt="Light Mode Icon" />
                <a href="https://github.com/CheemaMahesh" target="_blank">
                    <img className="w-8 h-8 p-1 rounded-full cursor-pointer hover:bg-[#2c3437]" src="src\assets\gitIcon.webp" alt="git icon" />
                </a>
